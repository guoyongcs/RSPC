...
def main(args):
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        if saver is not None:
            ...
            # if save_metric>79.45 and save_metric<79.55:
            #     try:
            #         src = os.path.join(saver.checkpoint_dir, 'last.pth.tar')
            #         dst = os.path.join(saver.checkpoint_dir, f'target-{epoch}.pth.tar')
    ...
    if 'CIFAR' in args.data_set:
        ...
        eval_inc(logger, model, torch.device('cuda'), args)
...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser('AFAT training and evaluation script', parents=[get_args_parser()])
